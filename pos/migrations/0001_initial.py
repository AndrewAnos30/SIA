    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buySize', models.CharField(blank=True, choices=[('small', 'Small'), ('medium', 'Medium'), ('large', 'Large')], max_length=15, null=True)),
                ...
                ('priceSize', models.IntegerField(blank=True, choices=[(0, '0'), (10, '10'), (20, '20')], null=True)),
            ],
        ),
        migrations.CreateModel(
            name='MenuCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotAndCold', models.CharField(choices=[('hot', 'Hot'), ('cold', 'Cold'), ('both', 'Hot and Cold')], default='hot', max_length=15)),
